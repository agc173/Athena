...
export const ENV = {
  ...
  PUSH_TEST_CALLABLE_ENABLED: optBool('PUSH_TEST_CALLABLE_ENABLED', false),
  PUSH_ENABLED: optBool('PUSH_ENABLED', false),
  PUSH_DAILY_HOROSCOPE_ENABLED: optBool('PUSH_DAILY_HOROSCOPE_ENABLED', false),
